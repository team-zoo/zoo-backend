...
module.exports = Router()
  ...
  .post('/', ensureAuth([roles.OWNER]), (req, res, next) => {
    const { name, type, status, zoo, photoUrl } = req.body;
    Animal
      .create({
        zoo,
        name, 
  ...
  .get('/stats/zoos-by-animal-count', (req, res, next) => {
    Animal
  ...
  .get('/stats/zoos-prolific-animal-type-all', (req, res, next) => {
    Animal
  ...
  .get('/stats/fav-animal-all', (req, res, next) => {
    Visitor
