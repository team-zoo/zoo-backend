...
const groupByZooAndAddAnimals = ({ $group: { _id: '$zoo', animalCount: { $sum: 1 } } });
const groupByTypeAndAddAnimals = ({ $group: { _id: '$type', animalCount: { $sum: 1 } } });
...
//Most prolific animal type across all zoos combined
